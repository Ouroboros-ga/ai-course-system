...
class AvatarProfileService:
    ...
    def disable_profile(
        ...
        *,
        ...
        profile.updated_at = utcnow_aware()
        session.add(profile)
    ...
    def soft_delete_profile(
        ...
        *,
        ...
        profile.deleted_at = utcnow_aware()
...
class AvatarSourceMediaService:
    ...
    def confirm_uploaded(
        ...
        *,
        ...
        source.verified_at = utcnow_aware()
...
class CourseAvatarBindingService:
    ...
    def publish_binding(
        ...
        *,
        ...
        binding.published_at = utcnow_aware()
        session.add(binding)
        session.flush()
        return binding
    ...
    def withdraw_binding(
        ...
        *,
        ...
        binding.withdrawn_at = utcnow_aware()
        session.add(binding)
        session.flush()
        return binding
