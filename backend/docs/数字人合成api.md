> **已废弃（2026-08-06，仅历史追溯）**：本文描述的服务端数字人合成接口不属于当前
> 阶段八主链，也不得作为课程 87 的实现或验收依据。现行路线见
> [`docs/phase1/阶段8_媒体TTS数字人PPT_实施规划.md`](../../docs/phase1/阶段8_媒体TTS数字人PPT_实施规划.md)：
> 平台预制 PixiJS 2D 角色由发布的 `avatar-cues/v1` 和音频时钟驱动；服务端不做逐帧合成。
