...
> **2026-09-08 学科知识库构建（PROPOSED）：**[自动化构建实施计划](phase1/2026-09-08_学科知识库自动化构建实施计划.md)，含 DK0–DK8 文件/接口/验收、全局参考与课程事实边界、增量/预算/回退、三入口接线及 50–80 有效工时估算。仅方案，真实抽取对照、编码和部署均未执行；现状差异见[功能现状审计表](phase1/功能现状审计表.md)。
