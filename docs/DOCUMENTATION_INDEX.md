...
> 2026-08-09 更新：首轮智能备课的材料证据整理已从单次 LLM 请求升级为有界 Map/Reduce，资源上限、证据追溯与验证数据登记在[统一课程建设与解析基线](phase1/统一课程建设与解析基线.md)和[功能现状审计表](phase1/功能现状审计表.md)。公开课程建设路由不变，无数据库迁移。
