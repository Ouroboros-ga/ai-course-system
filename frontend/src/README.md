# CodeNexus智码交响 - 智慧教学系统前端

证据驱动的 AI 互动智课生成与实时问答系统，为教师备课与学生学习提供轻量化、高效率的智慧教学解决方案。

## 项目简介

本项目结合 AI 大模型与 RAG 检索技术，实现智能课件生成、课堂互动、7×24 小时实时答疑。前端采用 Vue 3 + Vue Router + Pinia 构建，提供流畅的用户体验和响应式设计。
