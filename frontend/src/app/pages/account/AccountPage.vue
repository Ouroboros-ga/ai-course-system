...
<template>
  <div class="sfx-page sfx-page--narrow">
    <header class="sfx-page-header"><div><h1 class="sfx-t-title1"><UserRound :size="25" /> 个人中心</h1><p class="sfx-t-ui sfx-t-secondary sfx-page-header-sub">管理账户信息与数字人预设。</p></div></header>
