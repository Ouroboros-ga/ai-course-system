...
import { BookOpenCheck, FileText, ListTree, MonitorPlay, ShieldCheck, Sparkles, Video, Waypoints } from 'lucide-vue-next'
...
const workbench = reactive({ selectedNode, agentOpen })
    ...
    <div class="build-grid" :class="{ 'agent-is-open': agentOpen }">
      ...
      <section class="build-stage" aria-live="polite">
        <header class="stage-context">
          ...
          <button class="agent-trigger" type="button" @click="agentOpen = true"><Sparkles :size="17" /> 打开备课 Agent</button>
        </header>
        <router-view />
      </section>
