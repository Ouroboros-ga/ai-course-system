        ...
        <section ref="continueRef" class="sfx-home-continue">
            <div class="sfx-home-continue__inner">
                ...
                <div v-else class="sfx-home-continue__grid">
                    <article v-for="course in continueList" :key="course.course_id" class="sfx-home-continue-card"
                        tabindex="0" @click="enterCourse(course)" @keydown.enter="enterCourse(course)">
                        ...
                        <div class="sfx-home-continue-card__progress">
                            <div class="sfx-home-continue-card__bar">
                                <div class="sfx-home-continue-card__fill"
        ...
        <footer class="sfx-home-footer">
            ...
            <div class="sfx-home-footer__bottom">
                ...
                <div class="sfx-home-footer__bottom-right">
                    ...
                    <a class="sfx-home-footer__icp" href="https://beian.miit.gov.cn/" target="_blank" rel="noopener">
...
.glow-text:hover {
    filter: drop-shadow(0 0 18px rgba(77, 107, 254, 0.4)) drop-shadow(0 0 42px rgba(77, 107, 254, 0.18));
}
...
@keyframes brandFlow {
    ...
    100% {
        transform: translate(6%, -5%) rotate(8deg);
    }
}
