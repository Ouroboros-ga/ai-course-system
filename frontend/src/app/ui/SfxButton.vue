...
<template>
  ...
  >
    ...
    <span class="sfx-btn-label"><slot /></span>
  </button>
</template>
...
.sfx-btn.is-primary:hover:not(:disabled) { background: var(--color-brand-hover); }
.sfx-btn.is-primary:active:not(:disabled) { transform: translateY(1px); }
...
.sfx-btn.is-secondary:hover:not(:disabled) { background: var(--surface-cool); }
...
.sfx-btn.is-tertiary:hover:not(:disabled) { background: var(--ink-100); }
...
.sfx-btn.is-danger:hover:not(:disabled) { background: var(--red-100); }
