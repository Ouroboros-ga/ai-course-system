...
const UserBubble = defineAsyncComponent(() => import('@/components/chat/wait/bubble/user/UserBubble.vue'))
const AiBubble = defineAsyncComponent(() => import('@/components/chat/wait/bubble/ai/AiBubble.vue'))
